		 ...
		 System.out.println("쿠키가 없습니다.");
			...
			if (menu == 1 && traincnt >0) {
				...
				enemy1.fight();
					...
					System.out.println("용감한 쿠키에게 어떤 행동을 시키겠습니까? >>"
							+ "1.공격 2.도망친다");
				...
				if(command==1) {
					...
					enemyHp=enemyHp-atk;
					System.out.println(cookieName+"(은)는"+enemyName+"에게 쿠키 펀치를 날렸다"
			      	+ atk+"의 피해를 입혔다 남은"+ enemyName+"체력:"+enemyHp);
					nowHp =nowHp-enemyAtk;
					System.out.println(enemyName+"이(가)" +cookieName+"에게 세균펀치를 날렸다"

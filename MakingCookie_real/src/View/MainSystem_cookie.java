...
public class MainSystem_cookie {
	...
	public static void main(String[] args) {
		...
		int traincnt = 5;
			...
			System.out.println("용감한 쿠키를 더욱 강한 쿠키로 성장시켜주세요\r\n "
					+ "쿠키정보\r\n" + "=================================\r\n"
					+ "이름:용감한 쿠키\r\n" 
					+ "등급:하급 쿠키\r\n"
					+ "공격력:" + atk + "\r\n"
			...
			System.out.println("\r\n" 
					...
					+ "남은 훈련횟수: " + traincnt + "\r\n"
					+ "==================================================\r\n"
					+ "1.근력 훈련 2.민첩 훈련 3.체력 훈련 4.휴식 취하기 5.쿠키 진화 6.전투\r\n"
					+ "==================================================\r\n"
					+ "오늘 쿠키와 훈련 할 방법을 선택해주세요\r\n");
			
			int menu = sc.nextInt();
			if (menu == 1 && traincnt > 0) {
				System.out.println("쿠키가 쇠질을 하며 공격력이 올라갔습니다");
				atk += 5;
				traincnt--;
			} else if (menu == 2 && traincnt > 0) {
				System.out.println("쿠키카 민첩 훈련을 하며 민첩성이 올라갔습니다 ");
				dex += 5;
				traincnt--;
			} else if (menu==3 && traincnt >0 ) {
				System.out.println("쿠키가 유산소 운동을 하며 체력이 올라갔습니다");
				hp += 10;
				traincnt--;
			}
			day++;
